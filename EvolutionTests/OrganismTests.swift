...
final class OrganismTests: XCTestCase {
    ...
    func testOrganismInitialization() {
        let organism = Organism(speed: 15, senseRange: 150, size: 1.0, position: CGPoint(x: 100, y: 100), generation: 0, configuration: defaultConfig)
    ...
    func testSpeedClamping() {
        let tooSlow = Organism(speed: -5, senseRange: 150, size: 1.0, position: .zero, generation: 0, configuration: defaultConfig)
        XCTAssertEqual(tooSlow.speed, defaultConfig.minSpeed, "Speed should be clamped to minimum")

        let tooFast = Organism(speed: 100, senseRange: 150, size: 1.0, position: .zero, generation: 0, configuration: defaultConfig)
        XCTAssertEqual(tooFast.speed, defaultConfig.maxSpeed, "Speed should be clamped to maximum")
    }

    func testSenseRangeClamping() {
        let tooShort = Organism(speed: 10, senseRange: -50, size: 1.0, position: .zero, generation: 0, configuration: defaultConfig)
        XCTAssertEqual(tooShort.senseRange, defaultConfig.minSenseRange, "Sense range should be clamped to minimum")

        let tooLong = Organism(speed: 10, senseRange: 1000, size: 1.0, position: .zero, generation: 0, configuration: defaultConfig)
    ...
    func testSizeClamping() {
        let tooSmall = Organism(speed: 10, senseRange: 150, size: -1.0, position: .zero, generation: 0, configuration: defaultConfig)
        XCTAssertEqual(tooSmall.size, defaultConfig.minSize, accuracy: 0.01, "Size should be clamped to minimum")

        let tooLarge = Organism(speed: 10, senseRange: 150, size: 10.0, position: .zero, generation: 0, configuration: defaultConfig)
        XCTAssertEqual(tooLarge.size, defaultConfig.maxSize, accuracy: 0.01, "Size should be clamped to maximum")
    }

    func testReproduction() {
        let parent = Organism(speed: 10, senseRange: 150, size: 1.0, position: CGPoint(x: 100, y: 100), generation: 5, configuration: defaultConfig)
    ...
    func testReproductionMaintainsSpeedBounds() {
        ...
        let slowParent = Organism(speed: defaultConfig.minSpeed, senseRange: 150, size: 1.0, position: .zero, generation: 0, configuration: defaultConfig)
        for _ in 0..<20 {
        ...
        let fastParent = Organism(speed: defaultConfig.maxSpeed, senseRange: 150, size: 1.0, position: .zero, generation: 0, configuration: defaultConfig)
        for _ in 0..<20 {
    ...
    func testReproductionMaintainsSenseRangeBounds() {
        ...
        let shortSenseParent = Organism(speed: 10, senseRange: defaultConfig.minSenseRange, size: 1.0, position: .zero, generation: 0, configuration: defaultConfig)
        for _ in 0..<20 {
        ...
        let longSenseParent = Organism(speed: 10, senseRange: defaultConfig.maxSenseRange, size: 1.0, position: .zero, generation: 0, configuration: defaultConfig)
        for _ in 0..<20 {
    ...
    func testReproductionMaintainsSizeBounds() {
        ...
        let smallParent = Organism(speed: 10, senseRange: 150, size: defaultConfig.minSize, position: .zero, generation: 0, configuration: defaultConfig)
        for _ in 0..<20 {
        ...
        let largeParent = Organism(speed: 10, senseRange: 150, size: defaultConfig.maxSize, position: .zero, generation: 0, configuration: defaultConfig)
        for _ in 0..<20 {
    ...
    func testMovement() {
        let organism = Organism(speed: 10, senseRange: 150, size: 1.0, position: CGPoint(x: 0, y: 0), generation: 0, configuration: defaultConfig)
    ...
    func testSizeAffectsSpeed() {
        let smallOrganism = Organism(speed: 10, senseRange: 150, size: 0.5, position: .zero, generation: 0, configuration: defaultConfig)
        let largeOrganism = Organism(speed: 10, senseRange: 150, size: 2.0, position: .zero, generation: 0, configuration: defaultConfig)
    ...
    func testColorGradient() {
        let slowOrganism = Organism(speed: defaultConfig.minSpeed, senseRange: 150, size: 1.0, position: .zero, generation: 0, configuration: defaultConfig)
        let fastOrganism = Organism(speed: defaultConfig.maxSpeed, senseRange: 150, size: 1.0, position: .zero, generation: 0, configuration: defaultConfig)
    ...
    func testEquality() {
        let organism1 = Organism(speed: 10, senseRange: 150, size: 1.0, position: .zero, generation: 0, configuration: defaultConfig)
        let organism2 = Organism(speed: 15, senseRange: 200, size: 1.5, position: CGPoint(x: 100, y: 100), generation: 5, configuration: defaultConfig)
